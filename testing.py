...
def test_eliminarElemento_1():
    assert Laboratorio3.eliminarElemento( [12, 78, 12, 0, 5.2, "abc", 0, 12, 5.2, 12], 12 ) == [78, 0, 5.2, "abc", 0, 5.2]
    
def test_eliminarElemento_2():
    assert Laboratorio3.eliminarElemento( [12, 5.2, 12], 5 ) == [12, 5.2, 12]
    
    
def test_eliminarRepetidos_1():
    assert Laboratorio3.eliminarRepetidos( [12, 78, 12, 0, 5.2, "abc", 0, 12, 5.2, 12] , [12, 5.2, 0]) == [78, "abc"]
    
def test_eliminarRepetidos_2():
    assert Laboratorio3.eliminarRepetidos( [12, 5.2, 12], [12] ) == [5.2]
